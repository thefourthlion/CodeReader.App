...
function useListboxItem(originalProps) {
  ...
  const shouldFilterDOMProps = typeof Component === "string";
  const FragmentWrapper = href ? "a" : import_react2.Fragment;
...
var ListboxItem = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Component, { ...getItemProps(), children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(FragmentWrapper, { ...fragmentWrapperProps, children: [
    startContent,
...
var VirtualizedListbox = (props) => {
  ...
  if (!virtualization || !(0, import_shared_utils4.isEmpty)(virtualization) && !virtualization.maxListboxHeight && !virtualization.itemHeight) {
    throw new Error(
...
var Listbox = (0, import_system4.forwardRef)(function Listbox2(props, ref) {
  ...
  if (isVirtualized) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(virtualized_listbox_default, { ...props, ...useListboxProps });
  }
  const content = /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Component, { ...getListProps(), children: [
    !state.collection.size && !hideEmptyContent && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { ...getEmptyContentProps() }) }),
    [...state.collection].map((item) => {
      ...
      if (item.type === "section") {
        return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(listbox_section_default, { ...itemProps, itemClasses }, item.key);
      }
      let listboxItem2 = /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        listbox_item_default,
        {
          ...itemProps,
          classNames: (0, import_utils4.mergeProps)(itemClasses, (_a = item.props) == null ? void 0 : _a.classNames),
          shouldHighlightOnFocus
        },
        item.key
      );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { ...getBaseProps(), children: [
    topContent,
    content,
    bottomContent
  ] });
